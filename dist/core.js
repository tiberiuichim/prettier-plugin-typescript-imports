...
export async function fixTypeImports(options) {
    ...
    if (checkUsage) {
        console.log("Mode: Checking usage for implicit type imports (Batch Optimized)");
    }
 ...
 */
export function applyTransforms(sourceFile, checkUsage) {
...
export function organizeImports(code, filePath = "file.ts") {
    const project = new Project({
